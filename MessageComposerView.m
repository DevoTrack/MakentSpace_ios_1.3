...
- (void)setupFrames {
    ...
    if (_leftToRight) {
        sendButtonFrame.origin.x = 15;
        sendButtonFrame.origin.y = 0;
        messageTextViewFrame.origin.x = sendButtonFrame.origin.x + sendButtonFrame.size.width ;
        messageTextViewFrame.size.width = self.frame.size.width - _composerBackgroundInsets.right - sendButtonFrame.size.width+5 - _composerTVInsets.right - _composerTVInsets.left - _composerBackgroundInsets.left;
    } else {
        sendButtonFrame.origin.x = self.frame.size.width - _composerBackgroundInsets.right - sendButtonFrame.size.width+5;
        sendButtonFrame.origin.y = 0;
        messageTextViewFrame.size.width = sendButtonFrame.origin.x - _composerTVInsets.right - _composerTVInsets.left - _composerBackgroundInsets.left;
    }
