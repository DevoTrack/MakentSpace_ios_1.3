...
open class DropDown : UITextField{
    ...
    @IBInspectable public var selectedRowColor: UIColor = UIColor.appGuestThemeColor
...
//    }
    ...
    //Variables
    fileprivate  var tableheightX: CGFloat = 80
    ...
    func setupUI () {
        ...
        addGesture()
        //Mark:- Source Hides @Bootom Of The Code
    }
    ...
    public func showList(_ isIncrement : Bool = false) {
        ...
        UIView.animate(withDuration: 0.1,
                       ...
                       animations: { () -> Void in
                        ...
                        self.table.alpha = 1
                        if isIncrement{
                          self.table.frame.size.height = self.table.contentSize.height + 30.0
                        }else{
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.textLabel?.textAlignment = .left//self.textAlignment
        return cell!
    }
