...
open class FormTextField: UITextField, UITextFieldDelegate {
      @objc open dynamic var borderWidth1: CGFloat = 0 { didSet { self.layer.borderWidth = borderWidth1 } }
    @objc open dynamic var cornerRadius1: CGFloat = 0 { didSet { self.layer.cornerRadius = cornerRadius1 } }
