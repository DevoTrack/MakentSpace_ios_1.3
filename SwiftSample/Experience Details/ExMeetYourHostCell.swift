//
//  ExMeetYourHostCell.swift
//  Makent
//
//  Created by Ranjith Kumar on 9/24/18.
//  Copyright © 2018 Vignesh Palanivel. All rights reserved.
//

import UIKit

class ExMeetYourHostCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
//        let textAlignment = Language.getCurrentLanguage().getTextAlignment(align: .left)
//        self.aboutRoomLbl.textAlignment = textAlignment
    ...
    func populateData(title:String,subTitle:String) {
        ...
        if subTitle.count > 150{
            let first2Chars = String(subTitle.prefix(150))
